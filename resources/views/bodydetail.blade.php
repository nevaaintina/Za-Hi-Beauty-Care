...
@section('title', 'Detail Body Treatment - ZA & Hi')
...
<section class="min-h-screen py-8 px-4 sm:px-6 lg:px-8" style="background-color: #FFE2E2;">
    <div class="max-w-4xl mx-auto">
        ...
        {{-- Grid 4 Jenis Body Treatment (Struktur Grid yang Benar) --}}
        <div class="grid grid-cols-2 gap-8 text-center">
            ...
            <a href="/treatment/traditional-massage" class="block cursor-pointer">
                ...
                <div class="overflow-hidden rounded-lg shadow-xl hover:shadow-2xl transition duration-300">
                    <img src="{{ asset('images/detail-body-1.jpg') }}" alt="Traditional Massage" class="w-full h-auto object-cover">
                </div>
            </a>
            ...
            <a href="/treatment/body-scrub-mask" class="block cursor-pointer">
                ...
                <div class="overflow-hidden rounded-lg shadow-xl hover:shadow-2xl transition duration-300">
                    <img src="{{ asset('images/detail-body-2.jpg') }}" alt="Body Scrub & Mask" class="w-full h-auto object-cover">
                </div>
            </a>
            ...
            <a href="/treatment/reflexology" class="block cursor-pointer">
                ...
                <div class="overflow-hidden rounded-lg shadow-xl hover:shadow-2xl transition duration-300">
                    <img src="{{ asset('images/detail-body-3.jpg') }}" alt="Reflexology" class="w-full h-auto object-cover">
                </div>
            </a>
            ...
            <a href="/treatment/candle-wax-treatment" class="block cursor-pointer">
                ...
                <div class="overflow-hidden rounded-lg shadow-xl hover:shadow-2xl transition duration-300">
                    <img src="{{ asset('images/detail-body-4.jpg') }}" alt="Candle Wax Treatment" class="w-full h-auto object-cover">
                </div>
            </a>
