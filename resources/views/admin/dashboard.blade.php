    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-xl border border-gray-100 
            ...
            <div class="text-xs mt-2 font-semibold">
                <span class="{{ $usersColor }}">
                    <i class="{{ $usersArrow }}"></i> {{ $usersChange }}% since last week
                </span>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-xl border border-gray-100 
            ...
            <div class="text-xs mt-2 font-semibold">
                <span class="{{ $productsColor }}">
                    <i class="{{ $productsArrow }}"></i> {{ $productsChange }}% since last week
                </span>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-xl border border-gray-100 
            ...
            <div class="text-xs mt-2 font-semibold">
                <span class="{{ $servicesColor }}">
                    <i class="{{ $servicesArrow }}"></i> {{ $servicesChange }}% since last week
                </span>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-xl border border-gray-100 
            ...
            <div class="text-xs mt-2 font-semibold">
                <span class="{{ $testimonialsColor }}">
                    <i class="{{ $testimonialsArrow }}"></i> {{ $testimonialsChange }}% since last week
                </span>
            </div>
        </div>
    </div>
