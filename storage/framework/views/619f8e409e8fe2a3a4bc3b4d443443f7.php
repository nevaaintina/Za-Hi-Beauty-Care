<?php $__env->startSection('title', 'Detail Treatment - ZA & Hi'); ?>
...
<style>
    ...
    .hero-detail-bg {
        ...
        background-image: url('<?php echo e(asset('images/treatment-hero-placeholder.jpg')); ?>'); 
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="p-8 rounded-xl shadow-2xl" style="background-color: #E195AB;"> 
            ...
            <div class="w-full flex justify-center mb-8">
                <img src="<?php echo e(asset('images/hydra-facial-main.jpg')); ?>" alt="Hydra Facial Treatment" class="w-full max-w-xl rounded-lg shadow-xl border-4 border-white">
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Za-Hi-Beauty-Care\resources\views/treatmentdetail.blade.php ENDPATH**/ ?>