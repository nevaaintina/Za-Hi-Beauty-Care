<?php $__env->startSection('title', 'Profil Pengguna - ZA & Hi'); ?>
    ...
    <div class="max-w-6xl mx-auto flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-8">
        ...
        <div class="w-full md:w-2/3 bg-white p-8 rounded-xl shadow-lg border border-[#E195AB] flex flex-col items-center"
            ...
            <div class="w-48 h-48 rounded-full overflow-hidden border-4 border-[#E195AB] shadow-2xl mb-8">
                ...
                <img src="<?php echo e(asset('images/user-profile.jpg')); ?>" alt="Foto Profil Pengguna" class="w-full h-full object-cover">
            </div>
        ...
        <div class="w-full md:w-1/3 p-4 space-y-4">
            ...
            <div class="mt-10 pt-6 text-center">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="ZA & Hi Beauty Care Logo" class="mx-auto w-32 filter brightness-0 invert" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Za-Hi-Beauty-Care\resources\views\profile.blade.php ENDPATH**/ ?>