<footer class="bg-dark-pink text-white py-14 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start space-y-10 md:space-y-0">
        ...
        <div>
            ...
            <p class="flex items-center mb-2 text-sm md:text-base">
...
<?php /**PATH C:\laragon\www\Za-Hi-Beauty-Care\resources\views/layouts/footer.blade.php ENDPATH**/ ?>